...
export default function Services() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 m-auto w-[90%] gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-[#2B5F0F] rounded-lg p-6 flex flex-col justify-between min-h-[250px] w-full"
          >
            <div>
